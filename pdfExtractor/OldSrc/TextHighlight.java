...
public class TextHighlight extends PDFStreamEngine
{
    ...
    protected void  writePage() throws IOException
    {
        ...
        String matchTo = searchedWords.replace(" ","");
        ...
        for( int i = 0; i < charactersByArticle.size(); i++)
        {
            ...
            while( textIter.hasNext() )
            {
                ...
                TextPosition tempPosition = startPosition;
                ...
                while (matchTo.contains(characterValue)) {
                    endPosition = tempPosition;
                    tempPosition = (TextPosition) textIter.next();
                    characterValue = characterValue + tempPosition.getCharacter();
                ...
                try {
                    if (wordCount > matchTo.length()*3/4) {
//                        System.out.println("Word count " + wordCount + " " + characterValue + " str : " + searchedWords +
//                                " Position "+ startPosition.getX() );
